...
#To connect bootstrap classes with Django message tags
    # import os
...
SECRET_KEY = 's=w#1zuin%ee2_hq-$$ffzxvd*^9mc&9ee=5mx*r072rskuhgx'
...
EMAIL_USE_TLS = False
#EMAIL_USE_SSL = False
#python -m smtpd -n -c DebuggingServer localhost:1025 ______Code for openning server
