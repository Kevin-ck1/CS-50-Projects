# Generated by Django 3.1.4 on 2021-02-27 23:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.CharField(blank=True, max_length=132, null=True)),
                ('listing_open', models.BooleanField(default=True)),
                ('Bidder', models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listing_Bidder', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bidder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listing_bidder', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='auctionlisting',
            name='listing_category',
            field=models.ForeignKey(blank=True, default=1, on_delete=django.db.models.deletion.CASCADE, related_name='listing_category', to='auctions.category'),
        ),
        migrations.AddField(
            model_name='auctionlisting',
            name='watchBidder',
